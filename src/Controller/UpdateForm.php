...
<head>
    <meta charset='UTF-8'>
    <title>Dog Hotel | Update Form</title>
...
<body>
    <br>
    <h1>Update Your Data With This Form</h1>
    <hr>
    <br>
    ...
    <div class='formulario'>
        <form method='POST' action='UpdateData.php'>
            ...
            <br>
            <input type='text' id='ownername' name='ownername' value='$nombre'>
            <br><br>
            <label for='dogname'>Dog's name:</label>
            <br> 
            <input type='text' id='dogname' name='dogname' value='$uperro'>
            <br><br>
            <label for='dogname'>Second dog's name:</label>
            <br> 
            <input type='text' id='dogname' name='dogname2' value='$uperro2'>
            <br><br>
            <label for='dogname'>Third dog's name:</label>
            <br> 
            <input type='text' id='dogname' name='dogname3' value='$uperro3'>
            <br><br>
